...
void gameStart(){
  ...
  //Algoritma
  t = startTime();
  while(i < jumlah_pemain && waktuInput < 30){   //Perulangan Giliran Pemain
    konfirm = 0;
  ...
  if(waktuInput > 30){   //Jika waktuInput melenihi timer_sec (15mnt atau 25mnt)
  		system("cls");
...
void menu(){
  tampilMenu();		// Tampilan menu
  pilihMenu();		// Mengecek pilihan user
}
